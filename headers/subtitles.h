...
public:
  ...
  /*! fuction that returns the begining time of the line, used to show when a
   * line should apper in a video */
  QString getBeginTime() const { return m_beginTime; }
  /*! function that retures the end time of the line, used to show when a line
   * should disappear from a video */
